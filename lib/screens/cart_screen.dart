                    ...
                    children: [
                      Container(
                        ...
                        child: ElevatedButton.icon(
                          onPressed: () {},
                          label: const Text("Clear cart", style: TextStyle(
                            fontSize: 13,
                          ),),
                      ...
                      const Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text("Temporary price: ", style: TextStyle(
                                    fontWeight: FontWeight.w700,
                                    color: Colors.black,
                                    fontSize: 16
                                ),),
                                Text("200 USD", style: TextStyle(
                                  color: Color.fromRGBO(91, 184, 93, 1),
                      ...
                      Column(
                        children: [
                          ...
                          TextButton(
                              ...
                              child: const Text("Add another address", style: TextStyle(
