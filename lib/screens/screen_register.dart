      ...
      Container(
          ...
          child: Column(children: [
            ...
            if (passwordsMatch == false)
              Text("Password doesn't match previous entry",
                  style: TextStyle(color: Colors.red, fontSize: 10)),
            SizedBox(height: 4),
            ElevatedButton(
              onPressed: () async {
                ...
                if (is_error == true) {
                  ...
                  if (passwordsMatch == true && _isEmailValid == true) {
                    ...
                    var response = await user_api.register(emailController.text,
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  if (_isError == true) Text("Active user isn't successful"),
                  Center(
                    child: Container(
                      width: 240,
                      height: 25,
