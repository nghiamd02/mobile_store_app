  ...
  static Future<List<Address>> getAllAddresses() async {
    ...
    final response = await http.get(uri, headers: {
      ...
      HttpHeaders.authorizationHeader:
          "Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ2b3RpZW4xMjM0NUBnbWFpbC5jb20iLCJyb2xlcyI6W3siYXV0aG9yaXR5IjoiUm9sZV9DdXN0b21lciJ9XSwiaWF0IjoxNjkyNjExNDkyLCJleHAiOjE2OTI2Mjk0OTJ9.MEsAjrg1bwVeUWVF8l_0lj-hxLDLn4WaVAcw4mk_Uug"
    });
